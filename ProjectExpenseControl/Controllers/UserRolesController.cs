...
namespace ProjectExpenseControl.Controllers
{
    ...
    public class UserRolesController : Controller
    {
        ...
        {
            RoleRepository _repoRole = new RoleRepository();
            UserRepository _repoUser = new UserRepository();
            List<Role> lstRoles = new List<Role>();
            List<User> lstUsers = new List<User>();
            lstRoles = _repoRole.GetAll().ToList();
            lstUsers = _repoUser.GetAll().ToList();
            ViewBag.listaUsuarios = lstUsers;
            ViewBag.listaRoles = lstRoles;
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "USR_IDE_USER,TUSR_IDE_RESOURCE")] UserRole userRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "USR_IDE_USER,TUSR_IDE_RESOURCE")] UserRole userRole)
        {
            if (ModelState.IsValid)
            {
